    ...
    <main className="chat-panel">
      <div className="chat-header">
        {speaker ? (
          <div className="chat-header-inner">
            ...
            <div style={{ marginLeft: "auto", display: "flex", gap: "10px", alignItems: "center" }}>
              ...
              <button
                type="button"
                className="graph-toggle"
                style={{ marginLeft: 0, borderColor: "var(--accent)", color: "var(--text)" }}
          ...
          <div className="chat-header-inner">
            <div className="chat-header-text">
              <span className="chat-eyebrow">Exploring Universe</span>
              <h2>{activeUniverse.replace(/_/g, " ")}</h2>
              <span className="chat-sub">Select a character below to start a dynamic chat thread</span>
            </div>
            <div style={{ marginLeft: "auto", display: "flex", gap: "10px", alignItems: "center" }}>
              <button
                type="button"

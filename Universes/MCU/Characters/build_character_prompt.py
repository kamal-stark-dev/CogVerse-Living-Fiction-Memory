def build_character_prompt(raw_data: str) -> str:
    """
    Inserts user-provided raw character data into the MCU character prompt.
    """
...
Your task is to generate a complete MCU Character Knowledge Document.

Focus entirely on a single character from the Marvel Cinematic Universe.
